%
%   odeLawsonA - numerical solution of initial value problem of 
%   Ordinary Differential Equations
%
%   [Y]=odeLawsonA('FA', 'FI', T0, T, X0, H, Hmin, Hmax, eps, P)
%   
%   Returns numerical soluton Y=X(t) of X'=A(t)X+Fi(t) system of ODE for a 
...
%   Input arguments:
%
%   'FA' - m-function returning matrix A(t)
%   'FI' - m-function returning column vector Fi(t)
